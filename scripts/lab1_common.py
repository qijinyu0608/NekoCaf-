...
NON_FUNCTIONAL_REQUIREMENTS = [
    ...
    ("NFR-005", "可用性", "顾客端关键流程在移动端三步内完成预约", "顾客代表 A", "Should", "P2", "完成预约的主流程不超过 3 个关键操作页面", "BC-RESERVATION", "可用性走查", "Draft"),
    ("NFR-006", "兼容性", "顾客端需兼容微信小程序与主流移动浏览器", "顾客代表 B", "Should", "P2", "覆盖 iOS Safari、Android Chrome、微信小程序", "BC-RESERVATION", "兼容性测试", "Draft"),
    ("NFR-007", "可审计性", "关键运营操作需保留不少于 180 天的审计日志", "运营总监", "Must", "P2", "敏感操作日志保留 >= 180 天且支持检索", "BC-OPERATIONS", "日志审计检查", "Draft"),
    ("NFR-008", "可移植性", "核心服务可在容器环境中部署", "总览文档", "Should", "P2", "服务镜像化后可在统一运行环境启动", "BC-RESERVATION", "容器化验证", "Draft"),
    ("NFR-009", "功能适应性", "推荐结果需在 2 秒内返回并说明原因", "运营总监", "Could", "P3", "P95 推荐响应时间 <= 2s 且解释字段非空", "BC-RECOMMENDATION", "接口测试", "Draft"),
